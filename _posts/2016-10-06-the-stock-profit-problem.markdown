...
Get a Makefile for the following program [here](https://github.com/mrrusof/algorithms/the-stock-profit-problem/c).
...
Get a Makefile for the following program [here](https://github.com/mrrusof/algorithms/the-stock-profit-problem/golang).
...
Get a Makefile for the following program [here](https://github.com/mrrusof/algorithms/the-stock-profit-problem/java).
...
Get a Makefile for the following program [here](https://github.com/mrrusof/algorithms/the-stock-profit-problem/ocaml).
...
Get a Makefile for the following program [here](https://github.com/mrrusof/algorithms/the-stock-profit-problem/prolog).
